...
-(void) showOnsaleView
{
	...
	NSURLRequest *request = [[NSURLRequest alloc] initWithURL:onSaleUrl cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:15];
...
-(void) showWillsaleView
{
	...
	NSURLRequest *request = [[NSURLRequest alloc] initWithURL:willsaleUrl cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:15];
...
-(void) showCalenderView
{
	...
	NSURLRequest *request = [[NSURLRequest alloc] initWithURL:calenderUrl cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:15];
